...
export const mockElevenLabsVoices = [
  {
    ...
    name: "Charlotte - Irish",
    category: "elevenlabs",
    description: "Warm, clear, radio-friendly Irish voice. Default ElevenLabs voice for this project.",
    previewUrl: "",
    labels: { accent: "Irish", age: "30-50", style: "warm, direct" },
    source: "elevenlabs",
  },
  {
    voiceId: "XB0fDUnXU5powFXDhCwa",
    name: "Charlotte - Irish Character",
    category: "elevenlabs",
    description: "Grounded Irish character voice for conversational or lightly comic scripts.",
    previewUrl: "",
    labels: { accent: "Irish", age: "25-45", style: "natural, conversational" },
    source: "elevenlabs",
  },
  {
    voiceId: "XB0fDUnXU5powFXDhCwa",
    name: "Charlotte - Irish Legal Read",
    category: "elevenlabs",
    description: "Measured Irish legal or mandatory read with clarity ahead of speed.",
    previewUrl: "",
    labels: { accent: "Irish", age: "30-60", style: "measured, clear" },
    source: "elevenlabs",
  },
];
